...
│   │       ├── AuditLogs.vue       # 审计日志
│   │       ├── SystemMonitorView.vue # 系统监控视图
│   │       ├── SystemSettings.vue  # 系统设置
│   │       ├── SystemStats.vue     # 系统统计
│   │       ├── TrainingStats.vue   # 训练统计
...
│   │   ├── CacheStatsController.java # 缓存统计
│   │   ├── DataExportController.java # 数据导出
│   │   ├── HealthController.java   # 健康检查
│   │   ├── LoadRecoveryController.java # 负荷恢复
│   │   ├── NutritionController.java # 营养管理
...
系统集成了 SpringDoc OpenAPI，提供交互式API文档：
